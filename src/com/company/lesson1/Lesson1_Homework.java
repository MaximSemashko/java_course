...
public class Lesson1_Homework {
    public static void main(String[] args) {
        ...
        * 7. Create 3-5 different variables that describe you and me (for example age, name etc). Log this information in beautifull way. For example "Maxim <3 is 21 year old =) and she is so tall 0_0"
